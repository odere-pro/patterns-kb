...
**Anti-patterns** — 11 of them. Not to practise, only to recognise on sight.
Every one is what the patterns elsewhere exist to prevent.

Pages here: anemic-domain-model, big-ball-of-mud, boat-anchor, cache-stampede, deadlock, god-object, golden-hammer, hot-key, race-condition, spaghetti-code, stale-cache
